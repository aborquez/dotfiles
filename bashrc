...
# source /opt/root-6.18/bin/thisroot.sh
source /opt/root-6.22/bin/thisroot.sh

alias cluster='ssh -X ui.hpc.utfsm.cl'
alias emacs='emacs -fs'
alias clean='rm *~'
alias root='root -l'
alias jlab='ssh login.jlab.org'

export PRODIR=${HOME}/analysis-omega
export WORKDIR=${PRODIR}/out
